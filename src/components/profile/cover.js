...
import { createPosts } from "../../functions/Post";
...
export default function Cover({ cover, visitor }) {
  ...
  const updateCoverPicture = async () => {
    try {
      ...
      if (updated_picture === "ok") {
        const new_post = await createPosts(
          "coverPicture",
          null,
          null,
          res,
  ...
  return (
    <div className="profile_cover" ref={coverRef}>
      ...
      {cover && !coverPicture && (
        <img src={cover} className="cover" ref={cRefs}  alt="" />
      )}
      {!visitor && (
