...
export default function Friendship({ friendshipp, profileid }) {
  ...
  return (
    <div className="friendship">
          ...
          {friendsMenu && (
            <div className="open_cover_menu" ref={menu}>
              ...
              {friendship &&  friendship.following ? (
                ...
                >{console.log(friendship &&  friendship.following)}
      ...
      <button className={friendship &&  friendship.friends ? "blue_btn" : "gray_btn"}>
        <img
          src="../../../icons/message.png"
          className={friendship && friendship.friends && "invert"}
          alt=""
        />
        <span>Message</span>
      </button>
